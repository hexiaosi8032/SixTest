...
- (void)_setupSubviews
{
    ...
    //input textview
    _inputTextView = [[EaseTextView alloc] initWithFrame:CGRectMake(self.horizontalPadding, self.verticalPadding, self.frame.size.width - self.verticalPadding * 2 - 80, self.frame.size.height - self.verticalPadding * 2)];
...
//    _inputTextView.placeHolder = NSEaseLocalizedString(@"message.toolBar.inputPlaceHolder", @"input a new message");
    ...
    UIButton *sendButton = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.inputTextView.frame) + 10, self.verticalPadding, 70 - self.horizontalPadding, self.frame.size.height - self.verticalPadding * 2)];
